...
public class ChangePassword extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnCP1 = (Button) findViewById(R.id.btnCP1);
        etCP1 = (EditText) findViewById(R.id.etCP1);
        etCP2 = (EditText) findViewById(R.id.etCP2);
        etCP3 = (EditText) findViewById(R.id.etCP3);
